...
build_docker_image()
{
    ...
    LOG="Building Docker image manipulator:latest ..."
...
create_shared_folder()
{
    ...
    if [ ! -d "$HOME/Projects/Internal/RobotArm/shared/ros2" ]; then
        # Set a log message for folder creation
        LOG="Creating $HOME/Projects/Internal/RobotArm/shared/ros2 ..."
        ...
        mkdir -p $HOME/Projects/Internal/RobotArm/g/shared/ros2
    fi
}
